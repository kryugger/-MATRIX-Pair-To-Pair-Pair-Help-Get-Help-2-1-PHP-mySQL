    ...
    <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> AWAITING DONATIONS
...
<?php
$oop = mysql_query("SELECT `id`, `payto`, `pos`, `pkg`, `amount`, `payby`, `ctm`, `atm`, `ptm`, `aptm`, `ptyp`, `nameslip`, `img`, `status` FROM donation WHERE status='0' OR status='1' OR status='2'  ORDER BY id ASC");
