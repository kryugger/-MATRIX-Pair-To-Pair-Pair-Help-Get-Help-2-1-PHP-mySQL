    ...
    <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> TESTIMONIAL Manageent
...
if ($id==0) {
$res = mysql_query("INSERT INTO testimonial SET name='".$name."', txt='".$txt."'");
if($res){
...
$res = mysql_query("UPDATE testimonial SET name='".$name."', txt='".$txt."' WHERE id='".$id."'");
if($res){
...
<h4 class="modal-title" id="myModalLabel"> <b class="abir_act"></b> TESTIMONIAL</h4>
</div>
...
<textarea name="txt" class="form-control input-lg abir_amount" rows="5" placeholder="TEXT"></textarea>
