...
<div class="panel panel-primary">
<div class="panel-heading">
<h3 class="panel-title"><strong>BANK ACCOUNT</strong> </h3> </div>
<div class="panel-body" style="text-align: center;">

<h4>BANK NAME: <span><?php echo $udata['bank_name']; ?></span></h4>
<h4>ACCOUNT NAME: <span><?php echo $udata['bank_acname']; ?></span></h4>
<h4>ACCOUNT NUMBER: <span><?php echo $udata['bank_acno']; ?></span></h4>
...
<button class="button button-red button-xlarge button-rounded btn-block" data-toggle="modal" data-target=".modal-cant">I CANNOT PAY</button>
...
<h3 class="center">PAY TO THE ABOVE DETAILS AND ASK HIM TO CONFIRM</h3>
<!--  -->
